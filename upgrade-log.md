# Upgrade project SPFxIonic to v1.8.1
...
```sh
npm i @microsoft/sp-property-pane@1.8.1 -SE
```
...
```sh
npm i @microsoft/sp-core-library@1.8.1 @microsoft/sp-lodash-subset@1.8.1 @microsoft/sp-office-ui-fabric-core@1.8.1 @microsoft/sp-webpart-base@1.8.1 @microsoft/sp-property-pane@1.8.1 -SE
npm i @microsoft/sp-build-web@1.8.1 @microsoft/sp-module-interfaces@1.8.1 @microsoft/sp-webpart-workbench@1.8.1 @microsoft/sp-tslint-rules@1.8.1 -DE
npm dedupe
```
